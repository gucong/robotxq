...
union UcciCommStruct {
  ...
  struct {
    ...
    struct {
        uint32_t dwMoveCoord;
    };
};


extern int xb_mv_left;
extern int xb_mv_ctrl;
extern int xb_tm_left; /* in 1/100 s */
extern int xb_tm_ctrl;
extern int xb_tm_incr;
extern int xb_post;
extern int xb_ponder;
extern int xb_depth;
extern int xb_force;
extern int hint_mv;
